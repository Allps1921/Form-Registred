...
export function Professor() {
    ...
    const FieldValidation = (e) => {
        ...
        if (team === "" || country === "" || manager === "" || league === "") {
                    ...
                    <form onSubmit={FieldValidation}>
                        <div className="row">
                            ...
                            <div className="col">
                                ...
                                <select className="form-control" id="league">
                                    onChange={e => setLeague(e.target.value)} value={league}
                                    <option disabled selected hidden>Select League</option>
                    ...
                    <table className="table table-striped table-bordered mt-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Aston Villa</td>
                                <td className="text-center">Swiss</td>
